...
namespace LW__17
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Paint(object sender, PaintEventArgs e)
        {
            ...
            gr.DrawEllipse(new Pen(Color.DarkBlue, 2), rectCircle1);
            Rectangle rectCircle2 = new Rectangle(origin.X, origin.Y - scale, 2 * scale, 2 * scale);
            gr.DrawEllipse(new Pen(Color.DarkBlue, 2), rectCircle2);
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            if (!stop)
            {
                ...
                labelLW17.ForeColor = Color.FromArgb(rgb, rgb, 200, 222);
            }
        }
